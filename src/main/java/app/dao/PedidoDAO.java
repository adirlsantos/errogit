...
public interface PedidoDAO extends JpaRepository<Pedido, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.produto FROM PedidoItem entity WHERE entity.pedido.id = :id")
   ...
   */
  @Modifying
  @Query("DELETE FROM PedidoItem entity WHERE entity.pedido.id = :instanceId AND entity.produto.id = :relationId")
